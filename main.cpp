...
int main() {
    ...
    // Inicializa a variável que armazena o tempo do último frame em que o cronômetro foi atualizado
    ...
    while (!WindowShouldClose()) {
        ...
        if (estado == JOGO && tempo > 0) {
            ...
            if (!musicaTocando) { // acabou de entrar na tela JOGO
                PlayMusicStream(musicaFundo); // começa (ou retoma) a trilha
                musicaTocando = true;
            }
            else {
        ...
        if (estado == MENU) {
            ...
            if (IsMouseButtonPressed(MOUSE_LEFT_BUTTON)) {
                if (mouse.x >= 300 && mouse.x <= 500 && mouse.y >= 180 && mouse.y <= 230)
                    estado = ESCOLHA_DIC;
                if (mouse.x >= 300 && mouse.x <= 500 && mouse.y >= 260 && mouse.y <= 310)
                    estado = AJUDA;
                if (mouse.x >= 300 && mouse.x <= 500 && mouse.y >= 340 && mouse.y <= 390)
                    estado = CRIADORES;
                if (mouse.x >= 300 && mouse.x <= 500 && mouse.y >= 420 && mouse.y <= 470)
                    break;
            }
        } else if (estado == AJUDA) {
            desenharJanelaAjuda();
            if (IsMouseButtonPressed(MOUSE_LEFT_BUTTON)) {
                if (mouse.x >= 300 && mouse.x <= 500 && mouse.y >= 400 && mouse.y <= 450)
                    estado = MENU;
            }
            ...
            if (IsMouseButtonPressed(MOUSE_LEFT_BUTTON)) {
                if (mouse.x >= 220 && mouse.x <= 370 && mouse.y >= 200 && mouse.y <= 270) {
                    arquivoScore = "maiorpontuacao.txt";
                ...
                if (mouse.x >= 430 && mouse.x <= 580 && mouse.y >= 200 && mouse.y <= 270) {
                    arquivoScore = "highscore.txt";
                    carregarHighScore(arquivoScore);
